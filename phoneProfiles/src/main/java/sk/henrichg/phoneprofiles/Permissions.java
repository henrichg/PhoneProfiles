...
public class Permissions {
    ...
    public static boolean grantProfilePermissionsAndActivateActivity(Context context, Profile profile,
    ...
    public static boolean grantProfilePermissionsAndActivateNotification(Context context, Profile profile,
                                                             int startupSource, boolean interactive,
                                                             boolean forGUI, boolean monochrome, int monochromeValue) {
        List<PermissionType> permissions = checkProfilePermissions(context, profile);
        if (permissions.size() > 0) {
