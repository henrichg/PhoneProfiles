                            ...
                            implements PreferenceFragment.OnCreateNestedPreferenceFragment
{
    ...
    public void finish() {
        ...
        returnIntent.putExtra(PhoneProfilesPrefsActivity.EXTRA_RESET_EDITOR, sk.henrichg.phoneprofiles.Permissions.grantRootChanged);
    ...
    private void loadPreferences(int new_profile_mode, int predefinedProfileIndex) {
        ...
        if (profile != null)
        {
            ...
            String PREFS_NAME = ProfilePreferencesNestedFragment.PREFS_NAME_ACTIVITY;
        ...
        if (profile != null) {
            ...
            //if (startupSource != PPApplication.PREFERENCES_STARTUP_SOURCE_SHARED_PROFILE) {
                ...
                if ((activatedProfile != null) && (activatedProfile._id == profile._id))
                    ...
                    dataWrapper._activateProfile(profile, PPApplication.STARTUP_SOURCE_EDITOR, false, null);
