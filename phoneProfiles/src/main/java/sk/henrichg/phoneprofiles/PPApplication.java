...
public class PPApplication extends Application {
    ...
    static final String ACTION_EXPORT_PP_DATA_START_FROM_PPP = PPApplication.PACKAGE_NAME + ".ACTION_EXPORT_PP_DATA_START_FROM_PPP";
    static final String ACTION_EXPORT_PP_DATA_STOP_FROM_PPP = PPApplication.PACKAGE_NAME + ".ACTION_EXPORT_PP_DATA_STOP_FROM_PPP";
    static final String ACTION_EXPORT_PP_DATA_STOP_FROM_PP = PPApplication.PACKAGE_NAME + ".ACTION_EXPORT_PP_DATA_STOP_FROM_PP";
    ...
    //static final String ACTION_EXPORT_PP_DATA_SHORTCUTS_COUNT = PPApplication.PACKAGE_NAME + ".ACTION_EXPORT_PP_DATA_SHORTCUTS_COUNT";
    static final String ACTION_EXPORT_PP_DATA_SHORTCUTS = PPApplication.PACKAGE_NAME + ".ACTION_EXPORT_PP_DATA_SHORTCUTS";
